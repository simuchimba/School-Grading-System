...
int main()
{
   ...
   system("cls");
   cout<<"\n\n";
   cout<<"\t====================GRADING SYSTEM BY KUUNDA SIMUCHIMBA===================="<<endl;
   cout<<endl;
   cout<<"\t\t\t\t1. MAIN MENU\n\n";
   cout<<"\t\t\t\t2. EXIT\n\n";
...
void acceptdata()
{
    ...
    cin>>s.arc;
    cout<<"ENTER YOUR COMMUNICATION SKILLS MARK :";
    cin>>s.writing;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tCOMPUTER SCIENCE :"<<s.arc<<endl<<endl;
        cout<<"\t\t\t\tPHYSICS :"<<s.writing<<endl<<endl;
        cout<<"\t\t\t\tCOMMUNICATION SKILLS :"<<s.alg<<endl<<endl;
        cout<<"\t\t\t\tMATHEMATICS :"<<s.sum<<endl<<endl;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tCOMPUTER SCIENCE :"<<s.pro<<endl;
        cout<<"\t\t\t\tPHYSICS :"<<s.arc<<endl;
        cout<<"\t\t\t\tCOMMUNICATION SKILLS :"<<s.writing<<endl;
        cout<<"\t\t\t\tMATHEMATICS:"<<s.alg<<endl;
        cout<<"\t\t\t\tSUM :"<<s.sum<<endl;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        {
        cout<<"\t\t\t\tSTUDENT NAME :"<<s.name<<endl<<endl;
        cout<<"\t\t\t\tCOMPUTER SCIENCE :"<<s.pro<<endl<<endl;
        cout<<"\t\t\t\tPHYSICS :"<<s.arc<<endl<<endl;
        cout<<"\t\t\t\tCOMMUNICATION SKILLS :"<<s.writing<<endl<<endl;
        cout<<"\t\t\t\tMATHEMATICS :"<<s.alg<<endl<<endl;
...

{
    ...
    if(infile.fail())
    {
     ...
     infile.read(reinterpret_cast<char*>(&s),sizeof(student));
     {
        ...
        cout<<"\t\t\t\tSTUDENT ID NUMBER :"<<s.id<<endl<<endl;
        cout<<"\t\t\t\tSTUDENT ROLL NUMBER :"<<s.roll<<endl<<endl;
        cout<<"\t\t\t\tCOMPUTER SCIENCE MARK :"<<s.pro<<endl<<endl;
        cout<<"\t\t\t\tPHYSICS MARK :"<<s.arc<<endl<<endl;
        cout<<"\t\t\t\tCOMMUNICATION SKILLS MARK :"<<s.writing<<endl<<endl;
        cout<<"\t\t\t\tMATHEMATICS MARK :"<<s.alg<<endl<<endl;
        cout<<"============================================="<<endl;
    ...
    cout<<"ENTER YOUR PHYSICS MARK :";
    cin>>s.arc;
    cout<<"ENTER YOUR COMMUNIACTION SKILLS MARK :";
    cin>>s.writing;
    cout<<"ENTER YOUR MATHEMATICS MARK :";
    cin>>s.alg;
    s.sum=s.pro+s.arc+s.writing+s.alg;
